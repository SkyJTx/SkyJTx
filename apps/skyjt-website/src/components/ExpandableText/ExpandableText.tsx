    ...
    <span class={props.class}>
      ...
      <Show when={isTruncated()}>
        <button
          ...
          onClick={toggle}
          class="ml-1 text-primary hover:text-primary-focus font-semibold text-xs inline-flex items-center gap-0.5 underline-offset-2 hover:underline cursor-pointer focus:outline-hidden focus:ring-2 focus:ring-primary/50 rounded-xs"
        >
